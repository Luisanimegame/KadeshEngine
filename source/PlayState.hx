...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (FlxG.save.data.songPosition) // I dont wanna talk about this code :(
			{
				...
				songPosBar.createFilledBar(FlxColor.GRAY, FlxColor.fromRGB(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]));
				add(songPosBar);
		...
		kashWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " - " + CoolUtil.difficultyFromInt(storyDifficulty) + " | Kash Engine v0.15", 16);
		kashWatermark.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
		kashWatermark.scrollFactor.set();
		add(kashWatermark);

		if (PlayStateChangeables.useDownscroll)
			kashWatermark.y = FlxG.height * 0.9 + 45;
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
		    ...
		    var targetSpeed:Float = songSpeed * val1;
		    ...
		    if (val2 <= 0) {
		        ...
		        songSpeedTween = FlxTween.tween(this, { songSpeed: targetSpeed }, val2, {
		            ease: FlxEase.linear,
		            onComplete: function(twn:FlxTween) {
		                songSpeedTween = null;
		            }
